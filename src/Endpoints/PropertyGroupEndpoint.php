...
class PropertyGroupEndpoint extends Shopware6ApiConnector implements Shopware6EndpointInterface
{

    public function getAll(int|null $limit = null): BaseResponseModel {
        return $this->index(Endpoint::PROPERTY_GROUP, $limit);
    }

    public function getSingle(string $id): BaseResponseModel {
        return $this->get(Endpoint::PROPERTY_GROUP, $id);
    }
